			...
			<div class="row">
				...
				<div class="col-lg-11 col-md-10">
					...
					<div class="content-glass">
						...
						<!-- CAR GRID -->
						<div class="row mt-4">
							<div class="col-xl-3 col-lg-4 col-md-6 mb-4" v-for="car in cars" :key="car.id">
								<div class="car-card">
...
@media (max-width: 768px) {
	...
	/* Search box stacked vertically with proper spacing */
	.search-box {
		flex-direction: column;
		gap: 8px;
	}
...
export default {
	...
	data() {
		return {
			...
			filters: ['All Cars', 'Available', 'SUV', 'Sedan', 'Hatchback', 'Premium'],
